------------------------------------------------
-- This Source Was Developed By (TOKYO) @MFMVIP.--
--   This Is The Source Channel @MFMVIP .   --
--                - 𝗦𝗼𝘂𝗿𝗰𝗲 TOKYO-                 --
--        -- https://t.me/MFMVIP --         --
------------------------------------------------ 
...
local TheTOKYO = io.open("TheTOKYO", 'w')
TheTOKYO:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 TOKYO.lua
done
]])
TheTOKYO:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheTOKYO -X kill
screen -S TheTOKYO ./TheTOKYO
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheTOKYO;chmod +x Run;./Run')
end
...
TheTOKYO = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheTOKYO)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheTOKYO,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,911945965}  
...
Status = 0
Developers = Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 911945965 then
Status = 'مبرمج السورس'
elseif UserId == 758381470 then
Status = 'القيادة حمادة '
elseif ChatId == 5155577461 then
Status = 'حكك المبرمج '
elseif ChatId == 2052003627 then
Status = 'حكك حمادة '
elseif UserId == Sudo_Id then  
...
Status = Redis:get(TheTOKYO.."TOKYO:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheTOKYO.."TOKYO:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheTOKYO.."TOKYO:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheTOKYO.."TOKYO:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheTOKYO.."TOKYO:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheTOKYO.."TOKYO:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheTOKYO.."TOKYO:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheTOKYO.."TOKYO:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheTOKYO.."TOKYO:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheTOKYO.."TOKYO:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheTOKYO.."TOKYO:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheTOKYO.."TOKYO:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheTOKYO.."TOKYO:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘ ∫ خاصيه المسح *',
unLock   = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘ ∫ خاصيه الكتم *',
lockKid  = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘ ∫ خاصيه التقييد *',
lockKick = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n✘ ∫ خاصيه الطرد *',
Reply    = '[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)\n*ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheTOKYO).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheTOKYO..'TOKYO:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheTOKYO) then
...
msg.The_Controller = 1
elseif tonumber(msg.sender.chat_id) == 5155577461 then
msg.Name_Controller = 'حكك المبرمج '
msg.The_Controller = 1
elseif tonumber(msg.sender.chat_id) == 2052003627 then
...
elseif Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheTOKYO) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheTOKYO.."TOKYO:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheTOKYO.."TOKYO:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheTOKYO.."TOKYO:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheTOKYO.."TOKYO:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheTOKYO) then
return false
end
local floods = Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheTOKYO.."TOKYO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheTOKYO.."TOKYO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheTOKYO.."TOKYO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheTOKYO.."TOKYO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheTOKYO.."TOKYO:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheTOKYO.."TOKYO:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheTOKYO.."TOKYO:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheTOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheTOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheTOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Videonote_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheTOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheTOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheTOKYO.."TOKYO:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheTOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheTOKYO.."TOKYO:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheTOKYO.."TOKYO:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheTOKYO.."TOKYO:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheTOKYO.."TOKYO:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheTOKYO.."TOKYO:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheTOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheTOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheTOKYO.."TOKYO:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheTOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheTOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheTOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheTOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheTOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheTOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheTOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheTOKYO.."TOKYO:Command:List:Group"..msg_chat_id,text)
Redis:del(TheTOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheTOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheTOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheTOKYO.."TOKYO:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheTOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheTOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheTOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheTOKYO.."TOKYO:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheTOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheTOKYO.."TOKYO:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheTOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheTOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text and Redis:get(TheTOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
if text and Redis:get(TheTOKYO.."TOKYO:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Photo"..text..msg_chat_id)
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheTOKYO.."TOKYO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheTOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheTOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
if msg.content.audio then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheTOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheTOKYO.."TOKYO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheTOKYO.."TOKYO:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheTOKYO..'TOKYO:'..v..text)
end
Redis:del(TheTOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheTOKYO.."TOKYO:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheTOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheTOKYO.."TOKYO:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheTOKYO.."TOKYO:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheTOKYO..'TOKYO:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheTOKYO.."TOKYO:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheTOKYO..'TOKYO:GetTexting:DevTheTOKYO'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ✘' then 
Redis:del(TheTOKYO..'TOKYO:GetTexting:DevTheTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم الغاء حفظ كليشة المطور')
end
Redis:set(TheTOKYO..'TOKYO:Texting:DevTheTOKYO',text)
Redis:del(TheTOKYO..'TOKYO:GetTexting:DevTheTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم حفظ كليشة المطور')
end
if Redis:get(TheTOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✘ ∫  تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheTOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheTOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheTOKYO.."TOKYO:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✘ ∫  تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheTOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheTOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheTOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheTOKYO.."TOKYO:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheTOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheTOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheTOKYO.."TOKYO:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✘ ∫  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheTOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TheTOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheTOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheTOKYO.."TOKYO:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✘ ∫  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheTOKYO.."TOKYO:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Smile"..msg.chat_id) then
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTOKYO.."TOKYO:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheTOKYO.."TOKYO:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Monotonous"..msg.chat_id) then
Redis:del(TheTOKYO.."TOKYO:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheTOKYO.."TOKYO:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTOKYO.."TOKYO:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheTOKYO.."TOKYO:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTOKYO.."TOKYO:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheTOKYO.."TOKYO:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTOKYO.."TOKYO:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheTOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheTOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheTOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheTOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheTOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheTOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheTOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheTOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheTOKYO.."TOKYO:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Difference"..msg.chat_id) then 
Redis:del(TheTOKYO.."TOKYO:Game:Difference"..msg.chat_id)
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheTOKYO.."TOKYO:Game:Example"..msg.chat_id) then
if text == Redis:get(TheTOKYO.."TOKYO:Game:Example"..msg.chat_id) then 
Redis:del(TheTOKYO.."TOKYO:Game:Example"..msg.chat_id)
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if tonumber(TheTOKYO) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheTOKYO..'TOKYO:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheTOKYO.."TOKYO:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheTOKYO.."TOKYO:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheTOKYO.."TOKYO:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheTOKYO.."TOKYO:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheTOKYO) then 
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheTOKYO.."TOKYO:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheTOKYO.."TOKYO:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheTOKYO.."TOKYO:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheTOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ✘' then 
Redis:del(TheTOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheTOKYO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheTOKYO..'TOKYO:Channel:Join',ChannelUser) 
...
Redis:set(TheTOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheTOKYO..'TOKYO:Channel:Join')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheTOKYO..'TOKYO:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheTOKYO..'TOKYO:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheTOKYO.."TOKYO:SendBcBot") 
...
Redis:set(TheTOKYO.."TOKYO:SendBcBot",true) 
...
Redis:del(TheTOKYO.."TOKYO:LeftBot") 
...
Redis:set(TheTOKYO.."TOKYO:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✘ ∫  تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheTOKYO.."TOKYO:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheTOKYO.."TOKYO:AddSudosNew"..msg_chat_id)
...
Redis:set(TheTOKYO.."TOKYO:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheTOKYO..'TOKYO:ChekBotAdd')  
local UsersBot = Redis:smembers(TheTOKYO..'TOKYO:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheTOKYO..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheTOKYO.."TOKYO:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheTOKYO.."TOKYO:Originators:Group"..v)
local Manager = Redis:smembers(TheTOKYO.."TOKYO:Managers:Group"..v)
local Admin = Redis:smembers(TheTOKYO.."TOKYO:Addictive:Group"..v)
local Vips = Redis:smembers(TheTOKYO.."TOKYO:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheTOKYO.."TOKYO:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheTOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheTOKYO.."TOKYO:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheTOKYO.."TOKYO:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheTOKYO..'TOKYO:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*✘ ∫ عدد احصائيات البوت الكامله \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ عدد المجموعات : '..(Redis:scard(TheTOKYO..'TOKYO:ChekBotAdd') or 0)..'\n✘ ∫ عدد المشتركين : '..(Redis:scard(TheTOKYO..'TOKYO:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheTOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheTOKYO..'TOKYO:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheTOKYO..'TOKYO:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TheTOKYO.."TOKYO:ChekBotAdd",msg_chat_id)
Redis:set(TheTOKYO.."TOKYO:Status:Id"..msg_chat_id,true) ;Redis:set(TheTOKYO.."TOKYO:Status:Reply"..msg_chat_id,true) ;Redis:set(TheTOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheTOKYO.."TOKYO:Status:BanId"..msg_chat_id,true) ;Redis:set(TheTOKYO.."TOKYO:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheTOKYO.."TOKYO:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheTOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheTOKYO.."TOKYO:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheTOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
Redis:incr(TheTOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheTOKYO..'TOKYO:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✘ ∫ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheTOKYO.."TOKYO:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheTOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheTOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheTOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheTOKYO.."TOKYO:Set:Id:Group"..msg_chat_id)
if Redis:get(TheTOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheTOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheTOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*✘ ∫ ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheTOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheTOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*✘ ∫ ايديه : '..UserId..
'\n✘ ∫ معرفه : @'..UserName..
...
Redis:set(TheTOKYO.."TOKYO:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://t.me/TOKYO_TEAM"}, },}}
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheTOKYO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheTOKYO).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ✘ ∫ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ✘ ∫ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Developers:Groups",UserId) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheTOKYO.."TOKYO:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✘ ∫ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Developers:Groups",UserId) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheTOKYO.."TOKYO:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTOKYO.."TOKYO:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTOKYO.."TOKYO:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTOKYO.."TOKYO:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheTOKYO.."TOKYO:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTOKYO.."TOKYO:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*✘ ∫ قائمه مطورين البوت \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n'
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheTOKYO.."TOKYO:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheTOKYO.."TOKYO:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:BotFree",true) 
...
Redis:set(TheTOKYO.."TOKYO:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheTOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheTOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheTOKYO..'TOKYO1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheTOKYO..'TOKYO1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheTOKYO..'TOKYO1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheTOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheTOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheTOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheTOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheTOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheTOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheTOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheTOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheTOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheTOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheTOKYO.."TOKYO11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheTOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheTOKYO..'TOKYO11:Add:Rd:Sudo:Text'..text)
Redis:del(TheTOKYO..'TOKYO11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheTOKYO..'TOKYO11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheTOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheTOKYO.."TOKYO11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheTOKYO.."TOKYO11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheTOKYO.."TOKYO11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheTOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheTOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheTOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheTOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheTOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheTOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheTOKYO.."TOKYO:allM"..msg.chat_id, msg.id)
if Redis:get(TheTOKYO.."TOKYO:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheTOKYO.."TOKYO:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheTOKYO.."TOKYO:allM"..msg.chat_id)
...
Redis:del(TheTOKYO.."TOKYO:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheTOKYO.."TOKYO:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheTOKYO.."TOKYO:allM"..msg.chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheTOKYO.."TOKYO:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheTOKYO.."TOKYO:Status:yt"..msg.chat_id)
...
Redis:set(TheTOKYO.."TOKYO:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheTOKYO.."TOKYO:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheTOKYO.."TOKYO:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheTOKYO.."TOKYO:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Status:Id"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Status:Reply"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Status:BanId"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:BotFree") 
...
Redis:del(TheTOKYO.."TOKYO:TwaslBot") 
...
if Redis:sismember(TheTOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheTOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫  تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheTOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheTOKYO.."TOKYO:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheTOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheTOKYO.."TOKYO:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheTOKYO.."TOKYO:LeftBot") then
...
Redis:set(TheTOKYO.."TOKYO:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheTOKYO.."TOKYO:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheTOKYO.."TOKYO:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheTOKYO.."TOKYO:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheTOKYO..'TOKYO:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheTOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Lock:text"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Join"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:lockpin"..msg_chat_id)  
...
Redis:del(TheTOKYO.."TOKYO:Lock:edit"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheTOKYO..'TOKYO:'..lock..msg_chat_id)    
end
...
if text == "قران" then
Abs = math.random(2,140); 
local Text ='*✘ ∫ تم اختيار قران لك فقط*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 ❳',url="t.me/TOKYO_TEAM"}},
}
...
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheTOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Link"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Video"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:geam"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:vico"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:forward"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Document"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheTOKYO.."TOKYO:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheTOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheTOKYO.."TOKYO:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheTOKYO.."TOKYO:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheTOKYO.."TOKYO:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheTOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheTOKYO.."TOKYO:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheTOKYO.."TOKYO:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheTOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheTOKYO.."TOKYO:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheTOKYO.."TOKYO:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheTOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheTOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheTOKYO.."TOKYO:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheTOKYO.."TOKYO:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheTOKYO.."TOKYO:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheTOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✘ ∫ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheTOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheTOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheTOKYO.."TOKYO:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheTOKYO.."TOKYO:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheTOKYO.."TOKYO:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheTOKYO.."TOKYO:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/TOKYO_TEAM'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheTOKYO.."TOKYO:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheTOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheTOKYO..'TOKYO:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheTOKYO..'TOKYO:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد رسائلك هنا *~ '..(Redis:get(TheTOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد التعديلات هنا *~ '..(Redis:get(TheTOKYO..'TOKYO:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد جهاتك المضافه هنا *~ '..(Redis:get(TheTOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheTOKYO.."TOKYO:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✘ ∫  ارسل الان النص
 ✘ ∫  يمكنك اضافه :
...
Redis:del(TheTOKYO.."TOKYO:Set:Id:Groups")
...
Redis:setex(TheTOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل الان النص
✘ ∫ يمكنك اضافه :
✘ ∫ `#username` » اسم المستخدم
...
Redis:del(TheTOKYO.."TOKYO:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheTOKYO.."TOKYO:DevelopersQ:Groups") 
...
Redis:del(TheTOKYO.."TOKYO:Developers:Groups") 
...
Redis:del(TheTOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Originators:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Managers:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:BanAll:Groups") 
...
Redis:del(TheTOKYO.."TOKYO:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheTOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id) 
...
for k,v in pairs(list) do
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheTOKYO.."TOKYO:List:Manager"..msg_chat_id)
end
...
Redis:set(TheTOKYO.."TOKYO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheTOKYO.."TOKYO:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:vico"..v)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:Text"..v)   
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:Photo"..v)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:Video"..v)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:File"..v)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:Audio"..v)
Redis:del(TheTOKYO.."TOKYO:Add:Rd:Sudo:video_note"..v)
Redis:del(TheTOKYO.."TOKYO:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n"
for k,v in pairs(list) do
if Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:File"..v) then
db = "ملف ✘"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheTOKYO.."TOKYO:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheTOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheTOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheTOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل لي سواء كان 
...
Redis:setex(TheTOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheTOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheTOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheTOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheTOKYO..'TOKYO:GetTexting:DevTheTOKYO'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheTOKYO..'TOKYO:Texting:DevTheTOKYO')
...
local UserId_Info = LuaTele.searchPublicChat("MFMVIP")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/MFMVIP"}
},
{
{text = '❲ 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 ❳', url = "https://t.me/TOKYO_TEAM"},
},
...
if not Redis:get(TheTOKYO.."TOKYO:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheTOKYO.."TOKYO:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheTOKYO.."TOKYO:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
Redis:setex(TheTOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheTOKYO.."TOKYO:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheTOKYO.."TOKYO:Name:Bot") or "طوكيو") then
local NamesBot = (Redis:get(TheTOKYO.."TOKYO:Name:Bot") or "طوكيو")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(TheTOKYO..'TOKYO:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheTOKYO)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*✘ ∫ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheTOKYO..'TOKYO:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheTOKYO..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheTOKYO..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheTOKYO..'TOKYO:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheTOKYO.."TOKYO:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheTOKYO.."TOKYO:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheTOKYO.."TOKYO:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheTOKYO.."TOKYO:Status:Games"..msg.chat_id) then
Redis:del(TheTOKYO.."TOKYO:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheTOKYO.."TOKYO:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheTOKYO.."TOKYO:Status:Games"..msg.chat_id) then
Redis:del(TheTOKYO.."TOKYO:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheTOKYO.."TOKYO:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheTOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheTOKYO.."TOKYO:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheTOKYO.."TOKYO:Game:Example"..msg.chat_id,name)
...
local bank_users = Redis:smembers(TheTOKYO.."zrfffidtf")
...
local mony = Redis:get(TheTOKYO.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TheTOKYO..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(TheTOKYO.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(TheTOKYO.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheTOKYO.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(TheTOKYO.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheTOKYO.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TheTOKYO..':toob:Name:'..zwga_id)
fnte = Redis:get(TheTOKYO..':toob:Name:'..v[2])
...
if Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(TheTOKYO..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(TheTOKYO..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TheTOKYO..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TheTOKYO..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TheTOKYO..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TheTOKYO..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TheTOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TheTOKYO.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TheTOKYO.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TheTOKYO.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTOKYO..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(TheTOKYO..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TheTOKYO..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ عقد زواجكم\n✘ ∫ الزوج : "..alzog.."\n✘ ∫ الزوجه : "..albnt.." \n✘ ∫ المهر : "..mhrr.." دولار ","md")
end
if Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheTOKYO..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TheTOKYO..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(TheTOKYO..':toob:Name:'..zoog2)
...
if text == "خلع" then
if not Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TheTOKYO.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TheTOKYO.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TheTOKYO.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TheTOKYO.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TheTOKYO.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TheTOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TheTOKYO..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TheTOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TheTOKYO..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TheTOKYO..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(TheTOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "✘ ∫ لديك حساب بنكي مسبقاً\n\n✘ ∫ لعرض معلومات حسابك اكتب\n⤟︎ `حسابي`","md",true)
end
Redis:setex(TheTOKYO.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheTOKYO.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "بينانس ." then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "والت كارد ."
flossst = Redis:get(TheTOKYO.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheTOKYO.."nonna"..msg.sender.user_id,news)
Redis:set(TheTOKYO.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheTOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTOKYO.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTOKYO.."nonallname"..creditcc,news)
Redis:set(TheTOKYO.."nonallbalc"..creditcc,balas)
Redis:set(TheTOKYO.."nonallcc"..creditcc,creditcc)
Redis:set(TheTOKYO.."nonallban"..creditcc,text)
Redis:set(TheTOKYO.."nonallid"..creditcc,banid)
Redis:sadd(TheTOKYO.."noooybgy",msg.sender.user_id)
Redis:del(TheTOKYO.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheTOKYO.."nonna"..msg.sender.user_id,news)
Redis:set(TheTOKYO.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheTOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTOKYO.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTOKYO.."nonallname"..creditvi,news)
Redis:set(TheTOKYO.."nonallbalc"..creditvi,balas)
Redis:set(TheTOKYO.."nonallcc"..creditvi,creditvi)
Redis:set(TheTOKYO.."nonallban"..creditvi,text)
Redis:set(TheTOKYO.."nonallid"..creditvi,banid)
Redis:sadd(TheTOKYO.."noooybgy",msg.sender.user_id)
Redis:del(TheTOKYO.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheTOKYO.."nonna"..msg.sender.user_id,news)
Redis:set(TheTOKYO.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheTOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TheTOKYO.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheTOKYO.."nonallname"..creditex,news)
Redis:set(TheTOKYO.."nonallbalc"..creditex,balas)
Redis:set(TheTOKYO.."nonallcc"..creditex,creditex)
Redis:set(TheTOKYO.."nonallban"..creditex,text)
Redis:set(TheTOKYO.."nonallid"..creditex,banid)
Redis:sadd(TheTOKYO.."noooybgy",msg.sender.user_id)
Redis:del(TheTOKYO.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
Redis:srem(TheTOKYO.."noooybgy", msg.sender.user_id)
Redis:del(TheTOKYO.."noolb"..msg.sender.user_id)
Redis:del(TheTOKYO.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheTOKYO.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TheTOKYO.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TheTOKYO.."nool:flotysb"..v)
Redis:del(TheTOKYO.."zrffdcf"..v)
Redis:del(TheTOKYO.."innoo"..v)
Redis:del(TheTOKYO.."nnooooo"..v)
Redis:del(TheTOKYO.."nnoooo"..v)
Redis:del(TheTOKYO.."nnooo"..v)
Redis:del(TheTOKYO.."nnoo"..v)
Redis:del(TheTOKYO.."polic"..v)
Redis:del(TheTOKYO.."ashmvm"..v)
Redis:del(TheTOKYO.."hrame"..v)
Redis:del(TheTOKYO.."test:mmtlkat6"..v)
Redis:del(TheTOKYO.."zahbmm2"..v)
end
Redis:del(TheTOKYO.."ttpppi")
...
ballanceed = Redis:get(TheTOKYO.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheTOKYO.."noolb"..msg.sender.user_id)
gg = Redis:get(TheTOKYO.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheTOKYO.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheTOKYO.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheTOKYO.."nool:flotysb"..msg.sender.user_id) or 0
...
if text == 'مضاربه' then
if Redis:get(TheTOKYO.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheTOKYO.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(TheTOKYO.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheTOKYO.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TheTOKYO.."ttpppi",msg.sender.user_id)
Redis:setex(TheTOKYO.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheTOKYO.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(TheTOKYO.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheTOKYO.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TheTOKYO.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheTOKYO.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TheTOKYO.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('TOKYO:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('TOKYO:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('TOKYO:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('TOKYO:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
...
Redis:set(TheTOKYO.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheTOKYO.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(TheTOKYO.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheTOKYO.."noolb"..msg.sender.user_id)
gg = Redis:get(TheTOKYO.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheTOKYO.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheTOKYO.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheTOKYO.."transn" .. msg.sender.user_id)
...
if Redis:get(TheTOKYO.."nonallcc"..text) then
local UserNamey = Redis:get(TheTOKYO.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TheTOKYO.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TheTOKYO.."nnonb"..fsvhhh)
nouu = Redis:get(TheTOKYO.."nnonbn"..fsvhhh)
...
if text == "طوكيو" or text == "بوت" then
...
if Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
if Redis:get(TheTOKYO.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"✘ ∫ من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheTOKYO.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheTOKYO.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"✘ ∫ خذ بخشيش المحظوظين 3000 دولار 💰","md",true)
end
local jjjo = math.random(1,2000);
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(TheTOKYO.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"✘ ∫ خذ ي مطفر "..jjjo.." دولار 💰","md",true)
Redis:setex(TheTOKYO.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "✘ ∫ ماعندك حساب بنكي ارسل ⤟ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheTOKYO.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TheTOKYO.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "✘ ∫ فلوسه "..ballanceed.." دولار 💰","md",true)
else
...
if Redis:get(TheTOKYO.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheTOKYO.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"✘ ∫ زارفينه قبلك \n✘ ∫ يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(TheTOKYO.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(TheTOKYO.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(TheTOKYO.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(TheTOKYO.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(TheTOKYO.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(TheTOKYO.."ttpppi",msg.sender.user_id)
Redis:setex(TheTOKYO.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(TheTOKYO.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(TheTOKYO.."zrfffidtf",msg.sender.user_id)
Redis:setex(TheTOKYO.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(TheTOKYO.."noooybgy",msg.sender.user_id) then
if Redis:get(TheTOKYO.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheTOKYO.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
local NumberGame = Redis:get(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheTOKYO.."TOKYO:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheTOKYO.."TOKYO:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheTOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheTOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheTOKYO..'TOKYO:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheTOKYO.."TOKYO:Start:Bot") then
local CmdStart = '*\n✘ ∫ أهلآ بك في بوت '..(Redis:get(TheTOKYO.."TOKYO:Name:Bot") or "طوكيو")..
...
data = {
{
{text = '✘ السورس .', url = 't.me/TOKYO_TEAM'},{text = '✘ لتنصيب بوت .', url = 't.me/MFMVIP'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheTOKYO.."TOKYO:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheTOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheTOKYO.."TOKYO:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheTOKYO.."TOKYO:TwaslBot") and not Redis:sismember(TheTOKYO.."TOKYO:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheTOKYO.."TOKYO:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheTOKYO.."TOKYO:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheTOKYO..'TOKYO:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'✘ ∫ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheTOKYO..'TOKYO:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheTOKYO.."TOKYO:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheTOKYO..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheTOKYO.."TOKYO:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheTOKYO then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheTOKYO..'TOKYO:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheTOKYO.."TOKYO:Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheTOKYO.."TOKYO:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheTOKYO.."TOKYO:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheTOKYO.."TOKYO:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheTOKYO.."TOKYO1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheTOKYO.."TOKYO:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheTOKYO.."TOKYO:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTOKYO.."TOKYO:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTOKYO.."TOKYO1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTOKYO.."TOKYO:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTOKYO.."TOKYO:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheTOKYO.."TOKYO:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTOKYO.."TOKYO:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheTOKYO.."TOKYO:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheTOKYO.."TOKYO:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheTOKYO.."TOKYO:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheTOKYO..'TOKYO:'..lock..UserId[2],"del")    
end
...
if Text and Text:match("(%d+)/toop5") then
  ...
  local bank_users = Redis:smembers(TheTOKYO.."almtzog"..ChatId)
  top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
  mony_list = {}
  for k,v in pairs(bank_users) do
  local mony = Redis:get(TheTOKYO.."mznom"..ChatId..v)
  table.insert(mony_list, {tonumber(mony) , v})
  end
  table.sort(mony_list, function(a, b) return a[1] > b[1] end)
  num = 1
  ...
  for k,v in pairs(mony_list) do
  if num <= 10 then
  local zwga_id = Redis:get(TheTOKYO..ChatId..v[2].."rgalll2:")
  local user_name = LuaTele.getUser(v[2]).first_name
  local user_nambe = LuaTele.getUser(zwga_id).first_name
  ...
  ballancee = Redis:get(TheTOKYO.."zrffdcf"..IdUser) or 0
  local bank_users = Redis:smembers(TheTOKYO.."zrfffidtf")
  top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
  mony_list = {}
  for k,v in pairs(bank_users) do
  ...
  ballancee = Redis:get(TheTOKYO.."nool:flotysb"..IdUser) or 0
  local bank_users = Redis:smembers(TheTOKYO.."ttpppi")
  top_mony = "توب اغنى 25 شخص :\n\n"
  mony_list = {}
  for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheTOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTOKYO.."TOKYO:SilentGroup:Group"..ChatId) 
