...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TOKYO,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TOKYO.."TOKYO:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TOKYO.."TOKYO:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TOKYO.."TOKYO:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TOKYO.."TOKYO:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TOKYO.."TOKYO:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TOKYO.."TOKYO:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TOKYO.."TOKYO:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TOKYO.."TOKYO:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TOKYO.."TOKYO:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TOKYO.."TOKYO:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TOKYO.."TOKYO:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TOKYO.."TOKYO:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TOKYO.."TOKYO:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TOKYO.."TOKYO:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TOKYO.."TOKYO:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TOKYO.."TOKYO:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TOKYO.."TOKYO:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TOKYO.."TOKYO:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TOKYO.."TOKYO:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TOKYO.."TOKYO:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TOKYO.."TOKYO:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TOKYO.."TOKYO:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TOKYO.."TOKYO:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TOKYO.."TOKYO:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TOKYO.."TOKYO:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TOKYO.."TOKYO:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TOKYO.."TOKYO:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TOKYO.."TOKYO:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId)
}
end
...
JoinChannel = true
local Channel = Redis:get(TOKYO..'TOKYO:Channel:Join')
if Channel then
...
elseif Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TOKYO.."TOKYO:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TOKYO) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TOKYO.."TOKYO:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TOKYO.."TOKYO:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TOKYO.."TOKYO:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TOKYO.."TOKYO:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TOKYO) then
return false
end
local floods = Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TOKYO.."TOKYO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TOKYO.."TOKYO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."TOKYO:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TOKYO.."TOKYO:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TOKYO.."TOKYO:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TOKYO.."TOKYO:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TOKYO.."TOKYO:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TOKYO.."TOKYO:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(TOKYO..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TOKYO.."TOKYO:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TOKYO.."TOKYO:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TOKYO.."TOKYO:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TOKYO.."TOKYO:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TOKYO.."TOKYO:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TOKYO.."TOKYO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TOKYO.."TOKYO:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TOKYO.."TOKYO:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TOKYO.."TOKYO:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TOKYO.."TOKYO:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TOKYO.."TOKYO:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TOKYO.."TOKYO:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TOKYO.."TOKYO:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TOKYO.."TOKYO:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TOKYO.."TOKYO:Command:List:Group"..msg_chat_id,text)
Redis:del(TOKYO.."TOKYO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TOKYO.."TOKYO:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:del(TOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TOKYO.."TOKYO:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TOKYO.."TOKYO:Group:Rules" .. msg_chat_id,text) 
Redis:del(TOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TOKYO.."TOKYO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TOKYO.."TOKYO:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حذف الرد من الردود ","md",true)  
return false
end
end
if text and Redis:get(TOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TOKYO.."TOKYO:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Audio"..text..msg_chat_id)
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TOKYO.."TOKYO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TOKYO.."TOKYO:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TOKYO.."TOKYO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TOKYO.."TOKYO:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TOKYO..'TOKYO:'..v..text)
end
Redis:del(TOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TOKYO.."TOKYO:List:Rd:Sudo", text)
...
local list = Redis:smembers(TOKYO.."TOKYO:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TOKYO..'TOKYO:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TOKYO.."TOKYO:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TOKYO..'TOKYO:GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ✘' then 
Redis:del(TOKYO..'TOKYO:GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم الغاء حفظ كليشة المطور')
end
Redis:set(TOKYO..'TOKYO:Texting:DevTOKYO',text)
Redis:del(TOKYO..'TOKYO:GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم حفظ كليشة المطور')
end
if Redis:get(TOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✘ ∫  تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TOKYO.."TOKYO:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TOKYO.."TOKYO:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✘ ∫  تم تعين الايدي عام',"md",true)  
end
if Redis:get(TOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تعين الايدي","md",true)  
Redis:del(TOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TOKYO.."TOKYO:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TOKYO.."TOKYO:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✘ ∫  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ✘' then   
Redis:del(TOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✘ ∫ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TOKYO.."TOKYO:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✘ ∫  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TOKYO.."TOKYO:Game:Smile"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Smile"..msg.chat_id) then
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."TOKYO:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TOKYO.."TOKYO:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Monotonous"..msg.chat_id) then
Redis:del(TOKYO.."TOKYO:Game:Monotonous"..msg.chat_id)
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TOKYO.."TOKYO:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Riddles"..msg.chat_id) then
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."TOKYO:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TOKYO.."TOKYO:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."TOKYO:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TOKYO.."TOKYO:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Reflection"..msg.chat_id) then
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."TOKYO:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ لقد فزت في اللعبه \n✘ ∫ اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TOKYO.."TOKYO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TOKYO.."TOKYO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TOKYO.."TOKYO:Game:Difference"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Difference"..msg.chat_id) then 
Redis:del(TOKYO.."TOKYO:Game:Difference"..msg.chat_id)
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TOKYO.."TOKYO:Game:Example"..msg.chat_id) then
if text == Redis:get(TOKYO.."TOKYO:Game:Example"..msg.chat_id) then 
Redis:del(TOKYO.."TOKYO:Game:Example"..msg.chat_id)
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TOKYO..'TOKYO:Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(TOKYO..'TOKYO:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TOKYO.."TOKYO:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TOKYO.."TOKYO:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(TOKYO.."TOKYO:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ✘' then 
Redis:del(TOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TOKYO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘ ∫ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TOKYO..'TOKYO:Channel:Join',ChannelUser) 
...
Redis:set(TOKYO..'TOKYO:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TOKYO..'TOKYO:Channel:Join')
...
Redis:del(TOKYO.."TOKYO:SendBcBot") 
...
Redis:set(TOKYO.."TOKYO:SendBcBot",true) 
...
Redis:set(TOKYO.."TOKYO:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✘ ∫  تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TOKYO.."TOKYO:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TOKYO.."TOKYO:AddSudosNew"..msg_chat_id)
...
Redis:set(TOKYO.."TOKYO:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TOKYO..'TOKYO:ChekBotAdd')  
local UsersBot = Redis:smembers(TOKYO..'TOKYO:Num:User:Pv')  
...
local President = Redis:smembers(TOKYO.."TOKYO:TheBasics:Group"..v)
local Constructor = Redis:smembers(TOKYO.."TOKYO:Originators:Group"..v)
local Manager = Redis:smembers(TOKYO.."TOKYO:Managers:Group"..v)
local Admin = Redis:smembers(TOKYO.."TOKYO:Addictive:Group"..v)
local Vips = Redis:smembers(TOKYO.."TOKYO:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TOKYO.."TOKYO:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TOKYO.."TOKYO:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TOKYO.."TOKYO:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TOKYO..'TOKYO:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*✘ ∫ عدد احصائيات البوت الكامله \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n✘ ∫ عدد المجموعات : '..(Redis:scard(TOKYO..'TOKYO:ChekBotAdd') or 0)..'\n✘ ∫ عدد المشتركين : '..(Redis:scard(TOKYO..'TOKYO:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TOKYO..'TOKYO:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TOKYO..'TOKYO:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TOKYO.."TOKYO:ChekBotAdd",msg_chat_id)
Redis:set(TOKYO.."TOKYO:Status:Id"..msg_chat_id,true) ;Redis:set(TOKYO.."TOKYO:Status:Reply"..msg_chat_id,true) ;Redis:set(TOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TOKYO.."TOKYO:Status:BanId"..msg_chat_id,true) ;Redis:set(TOKYO.."TOKYO:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TOKYO.."TOKYO:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TOKYO.."TOKYO:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TOKYO.."TOKYO:ChekBotAdd",msg_chat_id) then
Redis:incr(TOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TOKYO..'TOKYO:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✘ ∫ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TOKYO.."TOKYO:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TOKYO.."TOKYO:Set:Id:Group"..msg_chat_id)
if Redis:get(TOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*✘ ∫ ايديه : '..UserId..
...
local TotalMsg = Redis:get(TOKYO..'TOKYO:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TOKYO..'TOKYO:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*✘ ∫ ايديه : '..UserId..
'\n✘ ∫ معرفه : @'..UserName..
...
Redis:set(TOKYO.."TOKYO:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ✘ ∫ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ✘ ∫ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Developers:Groups",UserId) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TOKYO.."TOKYO:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✘ ∫ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✘ ∫ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Developers:Groups",UserId) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✘ ∫ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TOKYO.."TOKYO:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."TOKYO:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."TOKYO:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."TOKYO:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TOKYO.."TOKYO:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."TOKYO:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*✘ ∫ قائمه مطورين البوت \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n'
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TOKYO.."TOKYO:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TOKYO.."TOKYO:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Status:Id"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:BotFree",true) 
...
Redis:set(TOKYO.."TOKYO:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TOKYO..'TOKYO1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TOKYO..'TOKYO1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TOKYO..'TOKYO1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TOKYO.."TOKYO1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TOKYO.."TOKYO1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TOKYO.."TOKYO1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TOKYO.."TOKYO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TOKYO.."TOKYO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TOKYO.."TOKYO1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TOKYO.."TOKYO1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TOKYO.."TOKYO1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
Redis:sadd(TOKYO.."TOKYO:allM"..msg.chat_id, msg.id)
if Redis:get(TOKYO.."TOKYO:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TOKYO.."TOKYO:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TOKYO.."TOKYO:allM"..msg.chat_id)
...
Redis:del(TOKYO.."TOKYO:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TOKYO.."TOKYO:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TOKYO.."TOKYO:allM"..msg.chat_id)  
...
Redis:del(TOKYO.."TOKYO:Status:Del:Media"..msg.chat_id)
...
Redis:set(TOKYO.."TOKYO:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TOKYO.."TOKYO:Status:yt"..msg.chat_id)
...
Redis:set(TOKYO.."TOKYO:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TOKYO.."TOKYO:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TOKYO.."TOKYO:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TOKYO.."TOKYO:Status:Welcome"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Status:Id"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Status:Reply"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Status:BanId"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:TwaslBot") 
...
if Redis:sismember(TOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TOKYO.."TOKYO:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(TOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✘ ∫  تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TOKYO.."TOKYO:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TOKYO.."TOKYO:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘ ∫ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TOKYO.."TOKYO:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TOKYO.."TOKYO:LeftBot") then
...
Redis:set(TOKYO.."TOKYO:Lock:text"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."TOKYO:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."TOKYO:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TOKYO.."TOKYO:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TOKYO.."TOKYO:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TOKYO.."TOKYO:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TOKYO..'TOKYO:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TOKYO.."TOKYO:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:Lock:text"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:Lock:Join"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:lockpin"..msg_chat_id)  
...
Redis:del(TOKYO.."TOKYO:Lock:edit"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TOKYO..'TOKYO:'..lock..msg_chat_id)    
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/qanele/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "متحركه" then
Abs = math.random(2,140); 
...
if ChannelJoin(msg) == false then
    ...
    Redis:set(TOKYO.."Lock:Lock:xn"..msg_chat_id,true) 
    LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"✘ ∫ تم قفل الاباحي").Lock,"md",true)  
    return false
    end 
...
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TOKYO.."TOKYO:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TOKYO.."TOKYO:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Link"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Photo"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Video"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Animation"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:geam"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Audio"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:vico"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:forward"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Document"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Contact"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Spam"..msg_chat_id)  
...
Redis:set(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."TOKYO:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TOKYO.."TOKYO:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TOKYO.."TOKYO:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TOKYO.."TOKYO:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TOKYO.."TOKYO:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
if not Redis:get(TOKYO.."TOKYO:Status:Welcome"..msg_chat_id) then
...
Redis:del(TOKYO.."TOKYO:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TOKYO.."TOKYO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TOKYO.."TOKYO:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TOKYO.."TOKYO:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TOKYO.."TOKYO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TOKYO.."TOKYO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TOKYO.."TOKYO:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TOKYO.."TOKYO:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TOKYO.."TOKYO:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TOKYO.."TOKYO:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TOKYO..'TOKYO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✘ ∫ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TOKYO.."TOKYO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TOKYO.."TOKYO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TOKYO.."TOKYO:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TOKYO.."TOKYO:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TOKYO.."TOKYO:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TOKYO.."TOKYO:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TOKYO.."TOKYO:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TOKYO.."TOKYO:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TOKYO.."TOKYO:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TOKYO.."TOKYO:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TOKYO..'TOKYO:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TOKYO..'TOKYO:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد رسائلك هنا *~ '..(Redis:get(TOKYO..'TOKYO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد التعديلات هنا *~ '..(Redis:get(TOKYO..'TOKYO:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✘ ∫ عدد جهاتك المضافه هنا *~ '..(Redis:get(TOKYO.."TOKYO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TOKYO.."TOKYO:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✘ ∫  ارسل الان النص
 ✘ ∫  يمكنك اضافه :
...
Redis:del(TOKYO.."TOKYO:Set:Id:Groups")
...
Redis:setex(TOKYO.."TOKYO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل الان النص
✘ ∫ يمكنك اضافه :
✘ ∫ `#username` » اسم المستخدم
...
Redis:del(TOKYO.."TOKYO:Set:Id:Group"..msg.chat_id)
...
Redis:del(TOKYO.."TOKYO:DevelopersQ:Groups") 
...
Redis:del(TOKYO.."TOKYO:Developers:Groups") 
...
Redis:del(TOKYO.."TOKYO:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Originators:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Managers:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Addictive:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:BanAll:Groups") 
...
Redis:del(TOKYO.."TOKYO:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."TOKYO:SilentGroup:Group"..msg_chat_id) 
...
for k,v in pairs(list) do
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TOKYO.."TOKYO:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TOKYO.."TOKYO:List:Manager"..msg_chat_id)
end
...
Redis:set(TOKYO.."TOKYO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TOKYO.."TOKYO:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:Gif"..v)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:vico"..v)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:stekr"..v)     
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:Text"..v)   
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:Photo"..v)
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:Video"..v)
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:File"..v)
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:Audio"..v)
Redis:del(TOKYO.."TOKYO:Add:Rd:Sudo:video_note"..v)
Redis:del(TOKYO.."TOKYO:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n"
for k,v in pairs(list) do
if Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:File"..v) then
db = "ملف ✘"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TOKYO.."TOKYO:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TOKYO.."TOKYO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TOKYO.."TOKYO:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TOKYO.."TOKYO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل لي سواء كان 
...
Redis:setex(TOKYO.."TOKYO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✘ ∫ ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TOKYO.."TOKYO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TOKYO.."TOKYO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TOKYO..'TOKYO:GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TOKYO..'TOKYO:Texting:DevTOKYO')
...
if not Redis:get(TOKYO.."TOKYO:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local msMF = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(rdbhoto).."&reply_to_message_id="..msMF.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
if text and text:match("^كول (.*)$")then
local m = text:match("^كول (.*)$")
if Redis:get(TOKYO.."TOKYO:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TOKYO.."TOKYO:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
local msMF = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(ban_ns).."&reply_to_message_id="..msMF.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
end
...
local msMF = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video="..video.."&caption=".. URL.escape(T).."&reply_to_message_id="..msMF.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if not Redis:get(TOKYO.."TOKYO:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(TOKYO.."TOKYO:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TOKYO.."TOKYO:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TOKYO.."TOKYO:Name:Bot") or "طوكيو") then
...
x = x + 1
Redis:srem(TOKYO..'TOKYO:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(TOKYO..'TOKYO:ChekBotAdd',Get_Chat.id)
...
Redis:srem(TOKYO..'TOKYO:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TOKYO.."TOKYO:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TOKYO.."TOKYO:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TOKYO.."TOKYO:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TOKYO.."TOKYO:Status:Games"..msg.chat_id) then
Redis:del(TOKYO.."TOKYO:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TOKYO.."TOKYO:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TOKYO.."TOKYO:Status:Games"..msg.chat_id) then
Redis:del(TOKYO.."TOKYO:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TOKYO.."TOKYO:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TOKYO.."TOKYO:Game:Difference"..msg.chat_id,name)
...
Redis:set(TOKYO.."TOKYO:Game:Example"..msg.chat_id,name)
...
local mony = Redis:get(TOKYO.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TOKYO..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
local bank_users = Redis:smembers(TOKYO.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TOKYO.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TOKYO..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TOKYO..':toob:Name:'..zwga_id)
fnte = Redis:get(TOKYO..':toob:Name:'..v[2])
...
local zoog2 = Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
...
local zoog2 = Redis:get(TOKYO..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TOKYO..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TOKYO..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TOKYO..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TOKYO..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TOKYO.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TOKYO.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TOKYO.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TOKYO.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TOKYO..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ عقد زواجكم\n✘ ∫ الزوج : "..alzog.."\n✘ ∫ الزوجه : "..albnt.." \n✘ ∫ المهر : "..mhrr.." دولار ","md")
end
if Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TOKYO..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TOKYO..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local MF = LuaTele.getUser(zoog2)
fntey = Redis:get(TOKYO..':toob:Name:'..zoog2)
...
if text == "خلع" then
if not Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..MF.first_name.." "
local zwga_id = Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TOKYO.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TOKYO.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TOKYO.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TOKYO.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TOKYO.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TOKYO.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TOKYO..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TOKYO..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TOKYO..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TOKYO..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TOKYO..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"✘ ∫ تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(TOKYO..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
Redis:set(TOKYO.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TOKYO.."nnonbn"..msg.sender.user_id,MF)
Redis:set(TOKYO.."nonallname"..creditcc,news)
Redis:set(TOKYO.."nonallbalc"..creditcc,balas)
Redis:set(TOKYO.."nonallcc"..creditcc,creditcc)
Redis:set(TOKYO.."nonallban"..creditcc,text)
...
local banid = msg.sender.user_id
Redis:set(TOKYO.."nonna"..msg.sender.user_id,news)
Redis:set(TOKYO.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TOKYO.."nnonbn"..msg.sender.user_id,MF)
Redis:set(TOKYO.."nonallname"..creditvi,news)
Redis:set(TOKYO.."nonallbalc"..creditvi,balas)
Redis:set(TOKYO.."nonallcc"..creditvi,creditvi)
Redis:set(TOKYO.."nonallban"..creditvi,text)
...
local banid = msg.sender.user_id
Redis:set(TOKYO.."nonna"..msg.sender.user_id,news)
Redis:set(TOKYO.."noolb"..msg.sender.user_id,creditex)
Redis:set(TOKYO.."nnonb"..msg.sender.user_id,text)
Redis:set(TOKYO.."nnonbn"..msg.sender.user_id,MF)
Redis:set(TOKYO.."nonallname"..creditex,news)
Redis:set(TOKYO.."nonallbalc"..creditex,balas)
Redis:set(TOKYO.."nonallcc"..creditex,creditex)
Redis:set(TOKYO.."nonallban"..creditex,text)
...
if Redis:sismember(TOKYO.."noooybgy",msg.sender.user_id) then
Redis:srem(TOKYO.."noooybgy", msg.sender.user_id)
Redis:del(TOKYO.."noolb"..msg.sender.user_id)
Redis:del(TOKYO.."zrffdcf"..msg.sender.user_id)
Redis:srem(TOKYO.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TOKYO.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TOKYO.."nool:flotysb"..v)
Redis:del(TOKYO.."zrffdcf"..v)
Redis:del(TOKYO.."innoo"..v)
Redis:del(TOKYO.."nnooooo"..v)
Redis:del(TOKYO.."nnoooo"..v)
Redis:del(TOKYO.."nnooo"..v)
Redis:del(TOKYO.."nnoo"..v)
Redis:del(TOKYO.."polic"..v)
Redis:del(TOKYO.."ashmvm"..v)
Redis:del(TOKYO.."hrame"..v)
Redis:del(TOKYO.."test:mmtlkat6"..v)
Redis:del(TOKYO.."zahbmm2"..v)
end
Redis:del(TOKYO.."ttpppi")
...
if Redis:sismember(TOKYO.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TOKYO.."noolb"..msg.sender.user_id)
MF = Redis:get(TOKYO.."nnonb"..msg.sender.user_id)
...
Redis:decrby(TOKYO.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TOKYO.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TOKYO.."nnooooo" .. msg.sender.user_id,1200, true)
...
Redis:incrby(TOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TOKYO.."ttpppi",msg.sender.user_id)
Redis:setex(TOKYO.."nnoooo" .. msg.sender.user_id,1200, true)
...
local check_time = Redis:ttl(TOKYO.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TOKYO.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TOKYO.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TOKYO.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TOKYO.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TOKYO.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TOKYO.."nool:flotysb"..msg.sender.user_id) or 0
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TOKYO.."noooybgy",msg.sender.user_id) then
...
if Redis:get(TOKYO.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TOKYO.."noolb"..msg.sender.user_id)
MF = Redis:get(TOKYO.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TOKYO.."nnonbn"..msg.sender.user_id)
...
if Redis:get(TOKYO.."nonallcc"..text) then
local UserNamey = Redis:get(TOKYO.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TOKYO.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TOKYO.."nnonb"..fsvhhh)
nouu = Redis:get(TOKYO.."nnonbn"..fsvhhh)
...
Redis:incrby(TOKYO.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(TOKYO.."nool:flotysb"..msg.sender.user_id ,UserNamey)
LuaTele.sendText(msg.chat_id,msg.id, "حوالة صادرة من البنك ⤟ ( "..MF.." )\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nالبنك : "..hsabe.."\nنوع البطاقة : "..nouu.."\n"..nsba.."\nالمبلغ : "..UserNameyy.." دولار 💰","md",true)
LuaTele.sendText(fsvhhh,0, "حوالة واردة من البنك ⤟ ( "..MF.." )\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." دولار 💰","md",true)
Redis:del(TOKYO.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TOKYO.."transn" .. msg.sender.user_id)
elseif MF ~= hsabe then
...
if Redis:sismember(TOKYO.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TOKYO.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "✘ ∫ فلوسه "..ballanceed.." دولار 💰","md",true)
else
...
Redis:sadd(TOKYO.."ttpppi",msg.sender.user_id)
Redis:setex(TOKYO.."hrame" .. Remsg.sender.user_id,900, true)
...
local NumberGame = Redis:get(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TOKYO.."TOKYO:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TOKYO.."TOKYO:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TOKYO.."TOKYO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TOKYO.."TOKYO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TOKYO..'TOKYO:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TOKYO.."TOKYO:Start:Bot") then
local CmdStart = '*\n✘ ∫ أهلآ بك في بوت '..(Redis:get(TOKYO.."TOKYO:Name:Bot") or "طوكيو")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TOKYO.."TOKYO:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TOKYO.."TOKYO:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TOKYO.."TOKYO:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TOKYO.."TOKYO:TwaslBot") and not Redis:sismember(TOKYO.."TOKYO:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TOKYO.."TOKYO:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TOKYO.."TOKYO:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TOKYO..'TOKYO:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'✘ ∫ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TOKYO..'TOKYO:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TOKYO.."TOKYO:ChekBotAdd",'-100'..data.supergroup.id)
...
if Redis:get(TOKYO.."TOKYO:Lock:tagservr"..data.message.chat_id) then
...
Redis:incr(TOKYO..'TOKYO:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TOKYO.."TOKYO:Lock:edit"..data.chat_id) then
...
data = {
{
{text = ' { OMF - بصمه }', data = 'oggidu@'..IdUser..'idv@'..listYt[3]}, 
},
{
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TOKYO.."TOKYO:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TOKYO.."TOKYO1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."TOKYO:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."TOKYO:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TOKYO.."TOKYO:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TOKYO.."TOKYO1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TOKYO.."TOKYO:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TOKYO.."TOKYO:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TOKYO.."TOKYO:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."TOKYO:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TOKYO.."TOKYO:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TOKYO..'TOKYO:'..lock..UserId[2],"del")    
end
...
if Text and Text:match("(%d+)/toop5") then
  ...
  for k,v in pairs(mony_list) do
  if num <= 10 then
  local zwga_id = Redis:get(TOKYO..ChatId..v[2].."rgalll2:")
  local user_name = LuaTele.getUser(v[2]).first_name
  local user_nambe = LuaTele.getUser(zwga_id).first_name
  ...
  ballancee = Redis:get(TOKYO.."zrffdcf"..IdUser) or 0
  local bank_users = Redis:smembers(TOKYO.."zrfffidtf")
  top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
  mony_list = {}
  for k,v in pairs(bank_users) do
  ...
  ballancee = Redis:get(TOKYO.."nool:flotysb"..IdUser) or 0
  local bank_users = Redis:smembers(TOKYO.."ttpppi")
  top_mony = "توب اغنى 25 شخص :\n\n"
  mony_list = {}
  for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TOKYO.."TOKYO:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"✘ ∫ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."TOKYO:SilentGroup:Group"..ChatId) 
