...
os.execute('chmod +x TOKYO;chmod +x Run;./Run')
end
...
TOKYO = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TOKYO)
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=TOKYO,token=Token}
LUATELE = URL.escape(""..TOKYO.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,911945965,758381470,420693277}  
...
Status = 0
Devss = Redis:sismember(TOKYO.."Devss:Groups",UserId) 
Dev = Redis:sismember(TOKYO.."Dev:Groups",UserId)
Supcreator = Redis:sismember(TOKYO.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(TOKYO.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(TOKYO.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(TOKYO.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(TOKYO.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(TOKYO.."Special:Group"..ChatId,UserId)
...
Status = 'البوت'
elseif Devss then
Status = Redis:get(TOKYO.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(TOKYO.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(TOKYO.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(TOKYO.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(TOKYO.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(TOKYO.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(TOKYO.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Special then
Status = Redis:get(TOKYO.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TOKYO.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TOKYO.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(TOKYO.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(TOKYO.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(TOKYO.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(TOKYO.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(TOKYO.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(TOKYO.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(TOKYO.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TOKYO.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(TOKYO.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TOKYO.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(TOKYO.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(TOKYO.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(TOKYO.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(TOKYO.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(TOKYO.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(TOKYO.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(TOKYO.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(TOKYO.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(TOKYO.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TOKYO.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(TOKYO.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(TOKYO.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(TOKYO.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(TOKYO.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(TOKYO.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(TOKYO.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(TOKYO.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(TOKYO.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(TOKYO.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(TOKYO.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(TOKYO.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(TOKYO.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(TOKYO.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(TOKYO.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(TOKYO.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(TOKYO.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(TOKYO.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(TOKYO.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(TOKYO.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(TOKYO.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(TOKYO.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(TOKYO.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(TOKYO.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(TOKYO.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(TOKYO.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(TOKYO.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(TOKYO.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(TOKYO.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(TOKYO.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(TOKYO.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(TOKYO.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TOKYO.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(TOKYO.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(TOKYO.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(TOKYO.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TOKYO.."SilentGroup:Group"..ChatId,UserId)
}
end
...
Special = Redis:sismember(TOKYO.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 911945965 then Status = true
elseif UserId == 758381470 then  Status = true
elseif UserId == 420693277 then  Status = true
elseif UserId == Sudo_Id then  Status = true
elseif UserId == TOKYO then Status = true
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TOKYO).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(TOKYO.."chfalse")
if chh then
...
if Redis:sismember(TOKYO.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(TOKYO.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(TOKYO.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(TOKYO.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(TOKYO.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(TOKYO.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(TOKYO.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
local msg_id = msg.id
--var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(TOKYO.."Lock:channell"..msg_chat_id) then
print(Redis:get(TOKYO.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
local m = Redis:get(TOKYO.."chadmin"..msg_chat_id) 
...
Redis:incr(TOKYO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(TOKYO) then
...
elseif Redis:sismember(TOKYO.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TOKYO.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TOKYO.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TOKYO.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TOKYO.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TOKYO.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TOKYO.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TOKYO.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TOKYO.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TOKYO.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TOKYO.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TOKYO.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TOKYO.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TOKYO.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TOKYO.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TOKYO) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TOKYO.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TOKYO.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TOKYO.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TOKYO.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اطلق دخول ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n◈ نورت المجموعه {'..Get_Chat.title..'}',"md")  
end
end
end
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TOKYO) then
return false
end
local floods = Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TOKYO.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TOKYO.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TOKYO.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TOKYO.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(TOKYO..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(TOKYO..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(TOKYO.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TOKYO.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TOKYO.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(TOKYO.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TOKYO.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TOKYO.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TOKYO.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TOKYO.."lockpin"..msg_chat_id)
...
Redis:incr(TOKYO.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TOKYO.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TOKYO.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TOKYO) then
local N = (Redis:get(TOKYO.."Name:Bot") or "براند")
photo = LuaTele.getUserProfilePhotos(TOKYO)
...
Redis:set(TOKYO.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TOKYO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TOKYO.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TOKYO.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TOKYO.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TOKYO.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TOKYO.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TOKYO.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TOKYO.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TOKYO.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TOKYO.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TOKYO.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TOKYO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(TOKYO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◈ لا امتلك صلاحية تغيير معلومات المجموعه ","md",true)
end
Redis:del(TOKYO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TOKYO.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TOKYO.."Lock:User:Name"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(TOKYO.."Lock:hashtak"..msg_chat_id)
local u = LuaTele.getUser(msg.sender.user_id)
local txx = " ◈ عذرآ عزيزي ⤟ 𓆩["..u.first_name.."](tg://user?id="..u.id..")𓆪\n◈ *ممنوع ارسال الهاشتاك*"
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(TOKYO.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TOKYO.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TOKYO.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TOKYO.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TOKYO.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end end
if text and (Redis:get(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TOKYO.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TOKYO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TOKYO.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TOKYO.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TOKYO.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TOKYO.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TOKYO.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TOKYO.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TOKYO.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TOKYO.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TOKYO.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TOKYO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TOKYO.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(TOKYO.."All:Get:Reides:Commands:Group"..text)
Redis:del(TOKYO.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TOKYO.."All:Command:List:Group",text)
...
Redis:del(TOKYO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TOKYO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TOKYO.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TOKYO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TOKYO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TOKYO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TOKYO.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TOKYO.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(TOKYO.."All:Command:List:Group",text)
Redis:del(TOKYO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(TOKYO.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(TOKYO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TOKYO.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TOKYO.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"◈ تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"◈ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(TOKYO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TOKYO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TOKYO.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TOKYO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TOKYO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TOKYO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TOKYO.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TOKYO.."Command:List:Group"..msg_chat_id,text)
Redis:del(TOKYO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TOKYO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TOKYO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈  تم الغاء حفظ الرابط","md",true) 
end
Redis:set(TOKYO.."Group:Link"..msg_chat_id,text)
Redis:del(TOKYO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈  تم حفظ الرابط بنجاح","md",true) 
end 
if Redis:get(TOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TOKYO.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حفظ ترحيب المجموعه","md",true) 
end
if Redis:get(TOKYO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TOKYO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TOKYO.."Group:Rules" .. msg_chat_id,text) 
Redis:del(TOKYO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TOKYO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TOKYO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TOKYO.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(TOKYO.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(TOKYO.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(TOKYO.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(TOKYO.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(TOKYO.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(TOKYO.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(TOKYO.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(TOKYO.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(TOKYO.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(TOKYO.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(TOKYO.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TOKYO.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TOKYO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(TOKYO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(TOKYO.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(TOKYO.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TOKYO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
Redis:del(TOKYO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TOKYO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TOKYO.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حذف الرد من الردود ","md",true)  
return false
end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= TOKYO then
local test = Redis:get(TOKYO.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TOKYO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TOKYO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(TOKYO.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(TOKYO.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(TOKYO.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(TOKYO.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(TOKYO.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(TOKYO.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(TOKYO.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(TOKYO.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(TOKYO.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(TOKYO.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(TOKYO.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حفظ الرد \n◈ ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  end
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TOKYO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TOKYO.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TOKYO.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
◈ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(TOKYO..''..v..text)
end
Redis:del(TOKYO.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TOKYO.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حذف الرد من الردود العامه","md",true)  
end end
if text and not Redis:get(TOKYO.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(TOKYO..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(TOKYO.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TOKYO.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TOKYO.."Add:Rd:Sudo:stekr"..text) 
local Text = Redis:get(TOKYO.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TOKYO.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(TOKYO.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(TOKYO.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(TOKYO.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(TOKYO.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(TOKYO.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(TOKYO.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(TOKYO.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TOKYO..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(TOKYO.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(TOKYO.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TOKYO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TOKYO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TOKYO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id) 
local Texingt = Redis:get(TOKYO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TOKYO.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(TOKYO.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(TOKYO.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(TOKYO.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(TOKYO.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TOKYO.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(TOKYO.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(TOKYO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(TOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ◈' then   
Redis:del(TOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TOKYO.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TOKYO.."TOKYO:PinMsegees:"..v,text)
end
end
...
if Redis:get(TOKYO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(TOKYO.."Num:User:Pv") 
...
if Redis:get(TOKYO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(TOKYO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TOKYO.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(TOKYO.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(TOKYO.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
LuaTele.deleteMessages(msg.chat_id,{[1]= msg_id})
LuaTele.sendText(msg.chat_id,0,'◈ عذرا يا ['..n..']('..d..') \n◈ عليك الاشتراك في قناه البوت للتمكن من التحدث هنا\n',"md",false, false, false, false, reply_markup)
return false 
end 
end
if Redis:get(TOKYO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TOKYO..'GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء ◈' then 
Redis:del(TOKYO..'GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◈ تم الغاء حفظ كليشة المطور')
end
Redis:set(TOKYO..'Texting:DevTOKYO',text)
Redis:del(TOKYO..'GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◈ تم حفظ كليشة المطور')
end
if Redis:get(TOKYO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TOKYO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TOKYO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TOKYO.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'◈ تم تعين الايدي عام',"md",true)  
end
if Redis:get(TOKYO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء امر تعين الايدي","md",true)  
Redis:del(TOKYO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TOKYO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TOKYO.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'◈ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(TOKYO.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(TOKYO.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TOKYO.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◈ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TOKYO.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◈ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(TOKYO.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TOKYO.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◈ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TOKYO.."Game:Smile"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Smile"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TOKYO.."mshaher"..msg.chat_id) then
if text == Redis:get(TOKYO.."mshaher"..msg.chat_id) then
Redis:del(TOKYO.."mshaher"..msg.chat_id)
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - شخصيات او مشاهير","md",true)  
end
end 
if Redis:get(TOKYO.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Monotonous"..msg.chat_id) then
Redis:del(TOKYO.."Game:Monotonous"..msg.chat_id)
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(TOKYO.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Riddles"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(TOKYO.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(TOKYO.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(TOKYO.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(TOKYO.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Reflection"..msg.chat_id) then
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TOKYO.."Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(TOKYO.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"◈ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TOKYO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TOKYO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TOKYO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"◈ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TOKYO.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TOKYO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TOKYO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TOKYO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TOKYO.."Game:Difference"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Difference"..msg.chat_id) then 
Redis:del(TOKYO.."Game:Difference"..msg.chat_id)
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(TOKYO.."Game:Example"..msg.chat_id) then
if text == Redis:get(TOKYO.."Game:Example"..msg.chat_id) then 
Redis:del(TOKYO.."Game:Example"..msg.chat_id)
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n◈ لقد فزت في اللعبه \n◈ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(TOKYO.."All:Get:Reides:Commands:Group"..text) or Redis:get(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(TOKYO.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(TOKYO.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(TOKYO.."chfalse")
Redis:set(TOKYO.."chfalse",ch)
Redis:del(TOKYO.."ch:admin")
Redis:set(TOKYO.."ch:admin",data.result.invite_link)
else
...
if tonumber(TOKYO) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'◈ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
LuaTele.sendText(msg_chat_id,msg_id,'◈ جاري استرجاع المشتركين والمجموعهات ...')
Y = 0
for k,v in pairs(FilesJson.UsersBot) do
Y = Y + 1
Redis:sadd(TOKYO..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TOKYO.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TOKYO.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TOKYO.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TOKYO.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TOKYO.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TOKYO.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TOKYO) then 
return LuaTele.sendText(msg_chat_id,msg_id,'◈ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TOKYO.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TOKYO.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TOKYO.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TOKYO.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TOKYO.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(TOKYO.."SendBcBot",true) 
...
Redis:set(TOKYO.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TOKYO.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء ◈' then   
Redis:del(TOKYO.."AddSudosNew"..msg_chat_id)
...
Redis:set(TOKYO.."AddSudosNew"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(TOKYO.."SendBcBot") then
...
Redis:setex(TOKYO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TOKYO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TOKYO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
◈ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(TOKYO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
◈ ارسل لي سواء كان
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(TOKYO.."TOKYO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
◈ ارسل لي سواء كان
❨ ملف ◈ ملصق ◈ متحركه ◈ صوره
 ◈ فيديو ◈ بصمه الفيديو ◈ بصمه ◈ صوت ◈ رساله ❩
...
if not Redis:get(TOKYO.."chmembers") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(TOKYO.."chmembers")
...
local Info_Members = Redis:smembers(TOKYO.."BanAll:Groups") 
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TOKYO.."TOKYO11:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id, '\n◈ ارسل الكلمه الان')
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TOKYO..'TOKYO11:Add:Rd:Sudo:Text'..text)
Redis:del(TOKYO..'TOKYO11:Add:Rd:Sudo:Text1'..text)
Redis:del(TOKYO..'TOKYO11:Add:Rd:Sudo:Text2'..text)
Redis:del(TOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TOKYO.."TOKYO11:List:Rd:Sudo", text)
...
local list = Redis:smembers(TOKYO.."TOKYO11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TOKYO.."TOKYO11:Add:Rd:Sudo:Text"..v) 
Redis:del(TOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TOKYO.."TOKYO11:List:Rd:Sudo")
end
...
Redis:set(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TOKYO.."TOKYO11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"◈ ارسل الكلمه التي تريد حذفها")
end
if text then  
local test = Redis:get(TOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(TOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(TOKYO.."TOKYO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TOKYO.."TOKYO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(TOKYO.."TOKYO11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TOKYO.."TOKYO11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TOKYO.."TOKYO11:Add:Rd:Sudo:Text2"..text)   
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/TOKYO_TEAM'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n◈ عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(TOKYO.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TOKYO.."Add:Rd:Sudo:Gif"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:vico"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:stekr"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Text"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Photo"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Photoc"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Video"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Videoc"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:File"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Audio"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:Audioc"..v)
Redis:del(TOKYO.."Add:Rd:Sudo:video_note"..v)
Redis:del(TOKYO.."List:Rd:Sudo")
end
...
Redis:set(TOKYO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:set(TOKYO.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},
...
if text and not Redis:sismember(TOKYO.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(TOKYO.."Spam:Group"..msg.sender.user_id) 
end
if text == 'تفعيل الاشتراك الاجباري لكل الاعضاء ◈' or text == 'تفعيل الاشتراك الاجباري لكل الاعضاء' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ هذا الامر يخص  '..Controller_Num(1)..'* ',"md",true)  
end
if not Redis:get(TOKYO.."chfalse") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(TOKYO.."chmembers","on")
...
Redis:set(TOKYO.."ch:addd"..msg.sender.user_id,"on")
...
local Groups = Redis:smembers(TOKYO..'ChekBotAdd')  
local UsersBot = Redis:smembers(TOKYO..'Num:User:Pv')  
local Get_Json = '{"BotId": '..TOKYO..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TOKYO.."Supcreator:Group"..v)
local Constructor = Redis:smembers(TOKYO.."Creator:Group"..v)
local Manager = Redis:smembers(TOKYO.."Manger:Group"..v)
local Admin = Redis:smembers(TOKYO.."Admin:Group"..v)
local Vips = Redis:smembers(TOKYO.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(TOKYO..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*◈ عدد احصائيات البوت الكامله \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n◈ عدد المجموعات : '..(Redis:scard(TOKYO..'ChekBotAdd') or 0)..'\n◈ عدد المشتركين : '..(Redis:scard(TOKYO..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TOKYO..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'◈ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TOKYO..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
if Redis:sismember(TOKYO.."ChekBotAdd",msg_chat_id) then
...
Redis:sadd(TOKYO.."ChekBotAdd",msg_chat_id)
Redis:set(TOKYO.."Status:Id"..msg_chat_id,true) ;Redis:del(TOKYO.."Status:Reply"..msg_chat_id) ;Redis:del(TOKYO.."Status:ReplySudo"..msg_chat_id) ;Redis:set(TOKYO.."Status:BanId"..msg_chat_id,true) ;Redis:set(TOKYO.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TOKYO.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TOKYO.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(TOKYO.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TOKYO.."ChekBotAdd",msg_chat_id) then
if text == 'ايدي' then
...
local TotalMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(TOKYO..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(TOKYO.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TOKYO.."Num:Add:Games"..msg.chat_id..UserId) or 0
if id3am then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(TOKYO.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TOKYO.."ch:admin")
...
local TotalMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TOKYO..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TOKYO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = { "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷",  "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷"}
local Description = Texting[math.random(#Texting)]
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
else UserInfousername = 'لا يوجد'
end
Get_Is_Id = Redis:get(TOKYO.."Set:Id:Group"..msg_chat_id) or Redis:get(TOKYO.."Set:Id:Groups")
if Redis:get(TOKYO.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TOKYO..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄ID ⤠ '..UserId..
...
local TotalMsg = Redis:get(TOKYO..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TOKYO..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄ID ⤠ '..UserId..
'\n⋄User Name ⤠ @'..UserName..
...
local vip = Redis:smembers(TOKYO.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(TOKYO.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(TOKYO.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(TOKYO.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(TOKYO.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(TOKYO.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(TOKYO.."Dev:Groups") 
local devss = Redis:smembers(TOKYO.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(TOKYO.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(TOKYO.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(TOKYO.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(TOKYO.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(TOKYO.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(TOKYO.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(TOKYO.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(TOKYO.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(TOKYO.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(TOKYO.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(TOKYO.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(TOKYO.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(TOKYO.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(TOKYO.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TOKYO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'◈ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TOKYO).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
----تنزيل تسليه -----
if TextMsg == "خول" then
if not Redis:sismember(TOKYO.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ اتعالج خلاص ?? ").Reply,"md",true)  
else
Redis:srem(TOKYO.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(TOKYO.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(TOKYO.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(TOKYO.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TOKYO.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TOKYO.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TOKYO.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ احسن برضوا دا عيل نجس 😂 ").Reply,"md",true)  
else
Redis:srem(TOKYO.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(TOKYO.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TOKYO.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(TOKYO.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TOKYO.."Devss:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Dev:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم رفعه سمب في المجموعه عقبال ميبقا زي النسوان الي تعبينو 😂  ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(TOKYO.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم رفعه قرد في المجموعه تعال خدلك موزه  😂  ").Reply,"md",true)  
end
end
if TextMsg == "ابني" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(TOKYO.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TOKYO.."Special:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◈ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Jabwa.first_name then
TOKYOusername = '*طلب ⤟ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ⤟ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
TOKYOusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,TOKYOusername,"md",false, false, false, false, reply_markup)
end
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(TOKYO..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
    ...
    if Redis:sismember(TOKYO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(TOKYO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(TOKYO..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(TOKYO..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تنزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(TOKYO..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(TOKYO..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(TOKYO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TOKYO..msg_chat_id.."mutlqat:")
...
Redis:set(TOKYO.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TOKYO.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TOKYO.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TOKYO.."Devss:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Dev:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"◈ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*◈ قائمه مطورين البوت \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷*\n'
...
local Info_Members = Redis:smembers(TOKYO.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TOKYO.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TOKYO.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TOKYO.."Status:Id"..msg_chat_id,true) 
...
Redis:set(TOKYO.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(TOKYO.."Status:Reply"..msg_chat_id) 
...
Redis:del(TOKYO.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(TOKYO.."Status:BanId"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(TOKYO.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TOKYO.."Status:Welcome"..msg_chat_id) 
...
Redis:del(TOKYO.."Status:Id"..msg_chat_id) 
...
Redis:del(TOKYO.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(TOKYO.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(TOKYO.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(TOKYO.."Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(TOKYO.."BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TOKYO.."BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TOKYO.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(TOKYO.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◈ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TOKYO.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TOKYO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TOKYO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◈ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if UserId == "758381470" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◈ عذرآ لا تستطيع استخدام الامر على القيادة حمادة *","md",true)  
end
if UserId == "420693277" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◈ عذرآ لا تستطيع استخدام الامر على مطور السورس*","md",true)  
end
if Redis:sismember(TOKYO.."BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."BanAll:Groups",UserId) 
...
if Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TOKYO.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TOKYO.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TOKYO.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◈ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(TOKYO.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(TOKYO.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TOKYO.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TOKYO.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TOKYO.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TOKYO.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TOKYO.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TOKYO.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TOKYO.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TOKYO.."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TOKYO.."ch:admin")
...
Redis:del(TOKYO.."myphoto"..msg_chat_id)
...
Redis:set(TOKYO.."myphoto"..msg_chat_id,"off")
...
Redis:del(TOKYO.."mybuti"..msg_chat_id)
...
Redis:set(TOKYO.."mybuti"..msg_chat_id,"off")
...
Redis:del(TOKYO.."sayy"..msg_chat_id)
...
Redis:set(TOKYO.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ تم امر امر قول* ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TOKYO.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TOKYO.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TOKYO.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(TOKYO.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if msg.sender.user_id == tonumber(911945965) then
LuaTele.sendText(msg_chat_id,msg_id,"◈ انت مبرمج السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(420693277) then
LuaTele.sendText(msg_chat_id,msg_id,"◈ انت مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(758381470) then
LuaTele.sendText(msg_chat_id,msg_id,"◈ انت القيادة حمادة يقلبي🌚♥","md",true)
...
LuaTele.sendText(msg_chat_id,msg_id,"◈ انت مالك المجموعه يقلبي🌚♥","md",true)
...
if Redis:get(TOKYO.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("http://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(TOKYO.."chadmin"..msg_chat_id,ch) 
...
Redis:del(TOKYO.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(TOKYO.."chadmin"..msg_chat_id) then
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TOKYO.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(TOKYO.."chadmin"..msg_chat_id) then
Redis:del(TOKYO.."chadmin"..msg_chat_id) 
...
Redis:set(TOKYO.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(TOKYO.."Lock:text"..msg_chat_id,true) 
...
Redis:set(TOKYO.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TOKYO.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TOKYO.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TOKYO.."lockalllll"..msg_chat_id,"on")
...
Redis:set(TOKYO.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TOKYO.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(TOKYO.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TOKYO..''..lock..msg_chat_id,"del")    
end
...
Redis:del(TOKYO.."Lock:AddMempar"..msg_chat_id)  
...
Redis:hset(TOKYO.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(TOKYO.."Lock:text"..msg_chat_id)  
...
Redis:del(TOKYO.."Lock:Join"..msg_chat_id)  
...
Redis:del(TOKYO.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TOKYO.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(TOKYO.."lockpin"..msg_chat_id)  
...
Redis:del(TOKYO.."Lock:edit"..msg_chat_id) 
...
Redis:del(TOKYO.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TOKYO..''..lock..msg_chat_id)    
end
...
Redis:hset(TOKYO.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TOKYO.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TOKYO.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TOKYO.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TOKYO.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TOKYO.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Link"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(TOKYO..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(TOKYO..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TOKYO..'lock:Fshar'..msg.chat_id) 
...
Redis:del(TOKYO..'lock:Fars'..msg.chat_id) 
...
Redis:set(TOKYO.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Photo"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Video"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Animation"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:geam"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Audio"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:vico"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:forward"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Document"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Contact"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Spam"..msg_chat_id)  
...
Redis:set(TOKYO.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TOKYO.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TOKYO.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TOKYO.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TOKYO.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TOKYO.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(TOKYO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TOKYO.."Status:Welcome"..msg_chat_id) then
...
Redis:del(TOKYO.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(TOKYO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TOKYO.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TOKYO.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TOKYO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TOKYO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TOKYO.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TOKYO.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(TOKYO.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TOKYO.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TOKYO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◈ ارسل الان { ملصق ,متحركه ,صوره ,رساله }*',"md",true)  
end
...
Redis:set(TOKYO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TOKYO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TOKYO.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(TOKYO.."All:Get:Reides:Commands:Group"..v)
Redis:del(TOKYO.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(TOKYO.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(TOKYO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TOKYO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(TOKYO.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TOKYO.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(TOKYO.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if not Redis:get(TOKYO.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if not Redis:get(TOKYO.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(TOKYO.."Status:AddMe"..msg.chat_id) then
...
data = {
{
  {text = 'قناه السورس', url = 't.me/TOKYO_TEAM'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TOKYO.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TOKYO.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TOKYO.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TOKYO.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TOKYO.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TOKYO.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TOKYO.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TOKYO.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if Redis:smembers(TOKYO.."Supcreator:Group"..msg_chat_id) then
Redis:del(TOKYO.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(TOKYO.."Creator:Group"..msg_chat_id) then
Redis:del(TOKYO.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(TOKYO.."Manger:Group"..msg_chat_id) then
Redis:del(TOKYO.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(TOKYO.."Admin:Group"..msg_chat_id) then
Redis:del(TOKYO.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(TOKYO.."Special:Group"..msg_chat_id) then
Redis:del(TOKYO.."Special:Group"..msg_chat_id) 
end
...
Redis:del(TOKYO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◈ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(TOKYO..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◈ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TOKYO..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◈ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'◈ عدد رسائلك هنا*~ '..(Redis:get(TOKYO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◈ عدد التعديلات هنا*~ '..(Redis:get(TOKYO..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◈ عدد جهاتك المضافه هنا*~ '..(Redis:get(TOKYO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TOKYO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◈ ارسل الان النص
◈ يمكنك اضافه :
...
Redis:setex(TOKYO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◈ ارسل الان النص
◈ يمكنك اضافه :
◈ `#username` » اسم المستخدم
...
Redis:del(TOKYO.."Set:Id:Group"..msg.chat_id)
...
Redis:del(TOKYO.."klb:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."kholat:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."2rd:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."8by:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."3ra:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."smb:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."mar:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."twhd:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."wtka:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(TOKYO.."SilentGroup:Group"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*◈ عدد المطرودين في المجموعه : "..#List_Members.."\n◈ تم الغاء الحظر عن ( "..x.." ) من الاشخاص*","md",true)  
end
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/TOKYOb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n◈ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(TOKYO.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TOKYO.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) 
Redis:del(TOKYO.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TOKYO.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(TOKYO.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(TOKYO.."List:Manager"..msg_chat_id)
end
...
text = "◈ قائمه الردود \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n"
for k,v in pairs(list) do
if Redis:get(TOKYO.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو ◈"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TOKYO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = 'الغاء الامر', data = msg.sender.user_id..'/cancelrdd'},},}}
...
if text then   
if Redis:get(TOKYO..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
local test = Redis:get(TOKYO..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(TOKYO.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(TOKYO.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(TOKYO.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ◈  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(TOKYO.."Add:Rd:array:Text"..gery..msg_chat_id,text)
LuaTele.sendText(msg_chat_id, msg_id,'* ◈  تم حذفه بنجاح .* ',"md",true)
end
end
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(TOKYO..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ◈  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:set(TOKYO.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(TOKYO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end

if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TOKYO.."Set:array"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TOKYO.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TOKYO.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TOKYO.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == "delrd" then
Redis:set(TOKYO.."Text:array"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TOKYO.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(TOKYO.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(TOKYO..'List:array'..msg_chat_id, text)
...
Redis:set(TOKYO.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
send_inlin_key(msg_chat_id,"◈  ارسل الكلمه التي تريد حذفها",inlin,msg_id)
return false 
end
if text then
if  Redis:sismember(TOKYO..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(TOKYO.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(TOKYO..'List:array'..msg_chat_id..'')
...
local list = Redis:smembers(TOKYO..'List:array'..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TOKYO.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(TOKYO..'List:array'..msg_chat_id)
end
...
Redis:set(TOKYO.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
text = "\n◈ قائمة الردود العامه \nٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n"
for k,v in pairs(list) do
if Redis:get(TOKYO.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:Text"..v) then
db = "رساله ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:File"..v) then
db = "ملف ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ◈"
elseif Redis:get(TOKYO.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ◈"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TOKYO..'GetTexting:DevTOKYO'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TOKYO..'Texting:DevTOKYO')
return LuaTele.sendText(msg_chat_id,msg_id,'◈ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevTOKYO = Redis:get(TOKYO..'Texting:DevTOKYO')
if TextingDevTOKYO then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevTOKYO,"md",true)  
else
...
if Redis:get(TOKYO.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if text and Redis:get(TOKYO..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(TOKYO..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(TOKYO..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
{{text = ' قناة السورس', url = "https://t.me/TOKYO_TEAM"}},}}
...
local Name = '*- 𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙏𝙤 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤.*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤', url = "http://t.me/TOKYO_TEAM"}
},
}
...
Redis:setex(TOKYO.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TOKYO.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"◈ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TOKYO.."Name:Bot") or "براند") then
local NamesBot = (Redis:get(TOKYO.."Name:Bot") or "براند")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
x = x + 1
Redis:srem(TOKYO..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TOKYO)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*◈ البوت عضو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره*',"md")
Redis:srem(TOKYO..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TOKYO..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TOKYO..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TOKYO..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TOKYO.."Game:Smile"..msg.chat_id,SM)
...
Redis:set(TOKYO.."mshaher"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(TOKYO.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TOKYO.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(TOKYO.."Status:Games"..msg.chat_id) then
Redis:del(TOKYO.."Set:Country"..msg.chat_id)
...
Redis:set(TOKYO.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TOKYO.."Status:Games"..msg.chat_id) then
Redis:del(TOKYO.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TOKYO.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TOKYO.."Status:Games"..msg.chat_id) then
Redis:del(TOKYO.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TOKYO.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(TOKYO.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TOKYO.."Game:Difference"..msg.chat_id,name)
...
Redis:set(TOKYO.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TOKYO.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TOKYO.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(TOKYO.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(TOKYO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤.؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤.؟ ", 
"كم مره حبيت؟ ", 
...
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TOKYO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:sadd(TOKYO..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
if not Redis:get(TOKYO.."Start:Bot") then
local CmdStart = '\n⋄مرحبا انا بوت '..(Redis:get(TOKYO.."Name:Bot") or "براند")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TOKYO.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه ب التفعيل والتعطيل ل𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع ◈',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه ب أحصائيات  𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ◈',type = 'text'},},
{{text = 'رجـوع ◈',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه ب المطورين ل𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ◈',type = 'text'},},
{{text = 'رجـوع ◈',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه بالاذاعه ل𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ◈',type = 'text'},},
{{text = 'رجـوع ◈',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه بالعام ل𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ◈',type = 'text'},},
{{text = 'رجـوع ◈',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'◈ اهلا بك مجددا عزيزي المطور \n◈ اليك الازرار الخاصه ببوتك المثبت علئ ل𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source TOKYO     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين ◈' then
...
Redis:setex(TOKYO.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(TOKYO.."TwaslBot") and not Redis:sismember(TOKYO.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TOKYO.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TOKYO.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TOKYO..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'◈ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TOKYO..'BaN:In:Tuasl',Info_User)  
...
reply_markup = {
inline_keyboard ={
{{text ="◈ TOKYO Source", url= "https://t.me/TOKYO_TEAM"}},
}
},
},
}
...
Redis:srem(TOKYO.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TOKYO..'*'..'-100'..data.supergroup.id..'*')
Redis:del(TOKYO.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(TOKYO.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TOKYO.."TOKYO:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TOKYO.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(TOKYO) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TOKYO..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == TOKYO then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TOKYO..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TOKYO.."Lock:edit"..data.chat_id) then
...
if tonumber(IdUser) == 911945965 then
data.The_Controller = 1
elseif tonumber(IdUser) == 758381470 then
data.The_Controller = 1
elseif tonumber(IdUser) == 420693277 then
data.The_Controller = 1
elseif The_ControllerAll(IdUser) == true then  
data.The_Controller = 1
elseif Redis:sismember(TOKYO.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(TOKYO.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(TOKYO.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(TOKYO.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(TOKYO.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(TOKYO.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(TOKYO.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(TOKYO.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(TOKYO) then
...
if Redis:sismember(TOKYO.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(TOKYO.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(TOKYO.."Creator:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."Special:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(TOKYO.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(TOKYO.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(TOKYO.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local Info_Members = Redis:smembers(TOKYO.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TOKYO.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
*]]
Redis:set(TOKYO.."youtube"..IdUser..ChatId,'mp3')
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤.', url = 't.me/TOKYO_TEAM'}, },}}
local TextHelp = [[*◈ ارسل اسم الفيديو من فضلك
◈ Send Video Name Please*]]
Redis:set(TOKYO.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local UserId = {Text:match('(%d+)/statusTheBasicsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusOriginatorsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(TOKYO.."TOKYO:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusManagersz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."TOKYO:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusAddictivez/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."TOKYO:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusDistinguishedz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TOKYO.."TOKYO:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(TOKYO.."TOKYO:Originators:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."TOKYO:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(TOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(TOKYO.."TOKYO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'banned',0)
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
...
if Redis:sismember(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(TOKYO.."TOKYO:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:incrby(TOKYO.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(TOKYO.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/TOKYO_TEAM'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/TOKYO_TEAM'}, },}}
Redis:del(TOKYO.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:array"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(TOKYO.."Set:On"..IdUser..":"..ChatId)
...
if Redis:get(TOKYO..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(TOKYO..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ TOKYO',url='http://t.me/TOKYO_TEAM'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ TOKYO',url='http://t.me/TOKYO_TEAM'}},}
...
local TextHelp = [[*
◈ أهلا بك في قائمة العاب 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤. اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{{text = 'قناه السورس', url = 't.me/TOKYO_TEAM'}, },}}
local TextHelp = [[*
◈ مرحبا بك في الالعاب المتطورة الخاص ب𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤.
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 'https://t.me/TOKYO_TEAM'}, },}}
local TextHelp = [[*◈ حسنا ارسل النص لترجمته الي العربيه*]]
Redis:set(TOKYO.."toar"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
Redis:set(TOKYO.."toen"..IdUser,"on")
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(TOKYO.."ChekBotAdd",UserId[2])
Redis:set(TOKYO.."Status:Id"..UserId[2],true) ;Redis:del(TOKYO.."Status:Reply"..UserId[2]) ;Redis:del(TOKYO.."Status:ReplySudo"..UserId[2]) ;Redis:set(TOKYO.."Status:BanId"..UserId[2],true) ;Redis:set(TOKYO.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TOKYO.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TOKYO.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"تعط")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"تفع")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"ا")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"م")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"اد")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"مد")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"من")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"اس")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"مط")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"تك")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"ر")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"رر")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"رد")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"سح")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"رس")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"غ")
Redis:set(TOKYO.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(TOKYO.."Command:List:Group"..ChatId,"#")
local txxt = [[
◈ تم ترتيب الاوامر بالشكل التالي ~
◈  ايدي - ا .
◈  رفع مميز - م .
...
TOKYOusername = '*تم الزواج بنجاح \nمبروك  يا  ⤟ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
TOKYOusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,TOKYOusername, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TOKYO.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TOKYO.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TOKYO.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TOKYO..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TOKYO.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Owners:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Creator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Manger:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Admin:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TOKYO.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
